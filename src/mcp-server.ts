...
export class CocosMCPServer {
  ...
  private getEventMapping(event: string): [string, string, ((d: ToolArgs) => any) | null] | null {
    const map: Record<string, [string, string, ((d: ToolArgs) => any) | null]> = {
      ...
      'scene-node-delete':      ['scene', 'remove-node', (d) => ({ uuid: d.nodeUuid || d.uuid })],
      ...
      'component-remove':       ['scene', 'remove-component', (d) => ({ uuid: d.nodeUuid, component: d.componentCid || d.componentType })],
      ...
      'component-slider-setup':       ['scene', 'execute-scene-script', (d) => ({ name: 'cocos-mcp-server', method: 'setComponentProperty', args: [d.nodeUuid, 'cc.Slider', d.property || 'progress', d.value] })],
      'component-toggle-setup':       ['scene', 'execute-scene-script', (d) => ({ name: 'cocos-mcp-server', method: 'setComponentProperty', args: [d.nodeUuid, 'cc.Toggle', d.property || 'isChecked', d.isChecked] })],
      ...
      'prefab-revert':          ['scene', 'set-property', (d) => ({ uuid: d.nodeUuid, path: '_prefab', dump: { value: null } })],
      'prefab-apply':           ['scene', 'set-property', (d) => ({ uuid: d.nodeUuid, path: '_prefab', dump: { value: null } })],
      ...
      'code-script-attach':     ['scene', 'execute-scene-script', null],
      'code-script-detach':     ['scene', 'execute-scene-script', null],
